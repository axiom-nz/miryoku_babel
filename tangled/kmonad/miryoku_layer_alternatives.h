...
U_LT(w, U_BUTTON), U_MT(x, ralt),     c,                 v,                 b,                 n,                 U_COMM,            .,                 U_MT(/, ralt),     U_LT(U_QUOT, U_BUTTON),\
U_NP,              U_NP,              U_LT(esc, U_MEDIA),U_LT(bspc, U_NAV), U_LT(tab, U_MOUSE),U_LT(ent, U_SYM),  U_LT(spc, U_NUM),  U_LT(del, U_FUN),  U_NP,              U_NP
...
q,                 s,                 d,                 f,                 g,                 h,                 j,                 k,                 l,                 m,                 \
w,                 x,                 c,                 v,                 b,                 n,                 U_COMM,            .,                 /,                 U_QUOT,            \
U_NP,              U_NP,              esc,               bspc,              tab,               ent,               spc,               del,               U_NP,              U_NP
